...
<table class="form-table">
	...
	<tr>
		...
		<td>
			<label><?php _e('Input class attribute values separated by space', 'auto-thickbox'); ?> (<code>&lt;a class="nothickbox"></code>)<br />
			<input type="text" name="auto-thickbox-plus[no_thickbox]" value="<?php $this->esc_attr($this->options['no_thickbox']); ?>" class="regular-text" /></label>
		</td>
	</tr>
	<tr>
