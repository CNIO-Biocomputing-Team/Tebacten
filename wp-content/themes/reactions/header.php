...
<head>
	...
	<script src="<?php bloginfo('template_url')?>/js/reactions.js"></script>
...
<body>
	...
	<div id="wrapper">
	<header id="top">
		<h1 id="applogo"><a href="<?php echo home_url( '/' ); ?>" title="" rel="home"><img src="<?php echo bloginfo('template_url'); ?>/images/tebacten_logo.png">TeBactEn</a></h1>
